...
public class Player : MonoBehaviour
{
    ...
    private float hp;       // Hit points for the player
    ...
    private bool pos_ok,        // Bool indicate if current position and value of position it's ok
                 ...
                 input_move;    // Bool represents if player is reading input for movement
    ...
    public bool Move()
    {
        ...
        // Movement
        if (target != Vector2.zero & !input_move)
        {
            input_move = true;
    ...
    IEnumerator WaitForMovementInput()
    {
        ...
        while(target.x == 0.0f & target.y == 0.0f)
        {
